...
function ResumeDetailPage() {
    ...
    const handleImprove = async (historyId, title, context) => {
        ...
        if (response.ok) {
            ...
            // Обработка специфической ошибки ResumeStatusExistsInBaseException
            if (data.detail && data.detail === "Данное обновление уже есть в базе") {
                alert("Ошибка: Это улучшение уже существует в базе данных");
            } else {
                    ...
                    {history.resume && (
                        <>
                            ...
                            <button
                                ...
                                onClick={() =>
                                    handleImprove(id, history.resume.title, history.resume.context)
                                }
                            >
                                Улучшить
                            </button>
